...
public class JdbctemplateApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		int numeroRegistros = jdbcTemplate.queryForObject("select count(*) from contatos", Integer.class);
		int numeroTelefoneEdson = jdbcTemplate.queryForObject("select telefone from contatos where nome = ?", Integer.class, "Edson Angoti Júnior");
		...
		*/
		...
		System.out.println("Número de Telefone Edson Angoti: "+numeroTelefoneEdson);
		System.out.println("\n-----------\n");
	}
